...
N_FEATURES = 3
N_OUTPUTS = None
RESULTS_FILE = 'results/experiment6/results_cnn_lstm.csv'
...
def preprocess_data(df, df_test, user):
    ...
    # they are saved so that the same can be used.
...
def main():
    ...
    for user in users:
        ...
        model_path = 'models/mobiact/cnn_lstm/base_model_{}.h5'.format(user)
